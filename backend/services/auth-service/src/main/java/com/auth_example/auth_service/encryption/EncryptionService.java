package com.auth_example.auth_service.encryption;
...
public class EncryptionService {
    ...
    public UUID decryptUuid(String encryptedBase64) {
        try {
            ...
            String plainString = new String(plainTextBytes, StandardCharsets.UTF_8);

            return UUID.fromString(plainString);
        } catch (Exception e) {
